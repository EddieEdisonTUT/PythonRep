...
elif manager2 < 500 and manager3 < 500:
...
elif manager1 < 500 and manager3 < 500:
...
elif manager1 >= 500 and manager1 < 1000 and manager3 >= 500 and manager3 < 1000:
...
elif manager1 >= 500 and manager1 < 1000 and manager2 >= 500 and manager2 < 1000:
    print('M1:',(manager1 * 0.05) + stavka)
    print('M2:',(manager2 * 0.05) + stavka)
if manager1 > manager2 and manager1 > manager3 and manager1 > 1000:
    print('Кращій М1:',(manager1 * 0.08) + stavka + 200)
elif manager2 > 1000 and manager3 > 1000:
...
elif manager1 > 1000 and manager3 > 1000:
...
elif manager1 > 1000 and manager2 > 1000:
    print('M1:',(manager1 * 0.08) + stavka)
    print('M2:',(manager2 * 0.08) + stavka)